/* baobab-treemap.c generated by valac 0.26.0.7-2832, the Vala compiler
...
static void baobab_treemap_draw_rectangle (BaobabTreemap* self, cairo_t* cr, gdouble x, gdouble y, gdouble width, gdouble height, GdkRGBA* fill_color, const gchar* text, gboolean show_text) {
	...
	if (_tmp21_) {
		...
		if (_tmp29_) {
			...
			_tmp46_ = layout;
			gtk_render_layout (_tmp36_, _tmp37_, (_tmp38_ + (_tmp39_ / 2)) - (_tmp41_ / 2), (_tmp42_ + (_tmp43_ / 2)) - (_tmp45_ / 2), _tmp46_);
		}
		_g_free0 (markup);
