/* main.c generated by valac 0.32.0.59-edc5, the Vala compiler
...
gint _vala_main (gchar** args, int args_length1) {
	...
	_tmp0_ = baobab_application_new ();
	baobab = _tmp0_;
	_tmp1_ = args;
	_tmp1__length1 = args_length1;
	_tmp2_ = g_application_run ((GApplication*) baobab, _tmp1__length1, _tmp1_);
	result = _tmp2_;
	_g_object_unref0 (baobab);
	return result;
}
