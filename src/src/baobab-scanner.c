/* baobab-scanner.c generated by valac 0.26.0.7-2832, the Vala compiler
...
static BaobabScannerResults* baobab_scanner_add_directory (BaobabScanner* self, GFile* directory, GFileInfo* info, BaobabScannerResults* parent) {
	...
	GAsyncQueue* _tmp126_ = NULL;
	BaobabScannerResultsArray* _tmp127_ = NULL;
	...
	_tmp120__length1 = _tmp119_->results_length1;
	{
		...
		for (child_results_it = 0; child_results_it < _tmp120__length1; child_results_it = child_results_it + 1) {
			...
			child_results = child_results_collection[child_results_it];
			{
				...
				BaobabScannerResults* _tmp122_ = NULL;
				guint64 _tmp123_ = 0ULL;
				BaobabScannerResults* _tmp124_ = NULL;
				guint64 _tmp125_ = 0ULL;
				_tmp121_ = child_results;
				_tmp122_ = child_results;
				_tmp123_ = _tmp122_->size;
				_tmp124_ = results;
				_tmp125_ = _tmp124_->size;
				_tmp121_->percent = (100 * ((gdouble) _tmp123_)) / ((gdouble) _tmp125_);
			}
		}
	}
	_tmp126_ = self->priv->results_queue;
	_tmp127_ = results_array;
	results_array = NULL;
	g_async_queue_push (_tmp126_, _tmp127_);
	result = results;
	_baobab_scanner_results_array_free0 (results_array);
	return result;
}
