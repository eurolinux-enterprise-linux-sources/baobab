...
static BaobabLocation* baobab_location_construct_for_home_folder (GType object_type) {
	...
	_tmp4_ = baobab_scanner_new (_tmp3_, BAOBAB_SCAN_FLAGS_NONE);
	_tmp5_ = _tmp4_;
...
BaobabLocation* baobab_location_construct_for_file (GType object_type, GFile* file_) {
	...
	baobab_location_get_fs_usage (self);
	_tmp9_ = self->priv->_file;
	_tmp10_ = baobab_scanner_new (_tmp9_, BAOBAB_SCAN_FLAGS_NONE);
	_tmp11_ = _tmp10_;
	baobab_location_set_scanner (self, _tmp11_);
	_g_object_unref0 (_tmp11_);
	return self;
...
BaobabLocation* baobab_location_new_for_file (GFile* file_) {
	return baobab_location_construct_for_file (BAOBAB_TYPE_LOCATION, file_);
}
...
static void baobab_location_fill_from_mount (BaobabLocation* self) {
	...
	baobab_location_get_fs_usage (self);
	_tmp17_ = self->priv->_file;
	_tmp18_ = baobab_scanner_new (_tmp17_, BAOBAB_SCAN_FLAGS_EXCLUDE_MOUNTS);
	_tmp19_ = _tmp18_;
	baobab_location_set_scanner (self, _tmp19_);
