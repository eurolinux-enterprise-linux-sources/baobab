/* baobab-location.c generated by valac 0.32.0.59-edc5, the Vala compiler
...
static void baobab_location_set_is_main_volume (BaobabLocation* self, gboolean value);
...
static void baobab_location_set_is_remote (BaobabLocation* self, gboolean value);
...
BaobabLocation* baobab_location_construct_for_recent_info (GType object_type, GtkRecentInfo* recent_info) {
	...
	_tmp8_ = _tmp7_;
	baobab_location_set_icon (self, _tmp8_);
	_g_object_unref0 (_tmp8_);
	_tmp9_ = recent_info;
	_tmp10_ = gtk_recent_info_is_local (_tmp9_);
	if (_tmp10_) {
		baobab_location_get_fs_usage (self);
	}
	_tmp11_ = self->priv->_file;
	_tmp12_ = baobab_scanner_new (_tmp11_, BAOBAB_SCAN_FLAGS_EXCLUDE_MOUNTS);
	_tmp13_ = _tmp12_;
	baobab_location_set_scanner (self, _tmp13_);
...
static void baobab_location_update_volume_info (BaobabLocation* self) {
	...
	_tmp4_ = g_volume_get_identifier (_tmp3_, G_VOLUME_IDENTIFIER_KIND_CLASS);
	_tmp5_ = _tmp4_;
	baobab_location_set_is_remote (self, g_strcmp0 (_tmp5_, "network") == 0);
	_g_free0 (_tmp5_);
	...
	if (_tmp6_ != NULL) {
		...
		_tmp9_ = _tmp8_;
		baobab_location_set_name (self, _tmp9_);
		_g_free0 (_tmp9_);
		_tmp10_ = self->priv->_volume;
		_tmp11_ = g_volume_get_icon (_tmp10_);
		_tmp12_ = _tmp11_;
		baobab_location_set_icon (self, _tmp12_);
		_g_object_unref0 (_tmp12_);
...
static void baobab_location_get_fs_usage (BaobabLocation* self) {
	...
	if (_tmp18_ != NULL) {
		...
		_tmp19_ = self->priv->_used;
		_tmp17_ = _tmp19_ != NULL;
	} else {
		_tmp17_ = FALSE;
	}
	if (_tmp17_) {
		guint64* _tmp20_ = NULL;
		guint64* _tmp21_ = NULL;
		_tmp20_ = self->priv->_used;
...
gboolean baobab_location_get_is_main_volume (BaobabLocation* self) {
	...
	gboolean _tmp0_ = FALSE;
	g_return_val_if_fail (self != NULL, FALSE);
	_tmp0_ = self->priv->_is_main_volume;
	result = _tmp0_;
	return result;
}
...
static void baobab_location_set_is_main_volume (BaobabLocation* self, gboolean value) {
	...
	g_return_if_fail (self != NULL);
	_tmp0_ = value;
	self->priv->_is_main_volume = _tmp0_;
}
